...
static class BuildTiltBrush
{
    ...
    public static void DoBuild(TiltBuildOptions tiltOptions)
    {
        ...
        string[] scenes = { "Assets/Scenes/StartScene.unity", "Assets/Scenes/Loading.unity", "Assets/Scenes/MakeFlag.unity", "Assets/Scenes/Test.unity", "Assets/Scenes/MainScene.unity", "Assets/Scenes/LoadingScene.unity", "Assets/Scenes/Pond.unity", "Assets/Scenes/Azit.unity", "Assets/Scenes/WestPrison.unity", "Assets/Scenes/Ending.unity", "Assets/Scenes/Classroom.unity" };
        ...
        using (var unused = new TempModifyScene(scenes[1]))
        using (var unused12 = new TempModifyScene(scenes[2]))
        // using (var unused123 = new TempModifyScene(scenes[2]))
        // using (var unused124 = new TempModifyScene(scenes[3]))
